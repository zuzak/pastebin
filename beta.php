...
<head>
	...
	<style>
		...
		{position:fixed;top:0;right:0}.controls div{background-color:#444;
	...
	<form method="POST">
		<div class="controls">
			...
			<div>
				...
				<label for="unlisted" title="Check this box to suppress the paste creation from being announced in any feeds.">No announce</label>
			</div>
		</div>
		<textarea name="paste" placeholder="<?php echo number_format( 100-($x/22.05), 2 ); ?>% approval rating (click to type)"></textarea>
	</form>
	<script>
